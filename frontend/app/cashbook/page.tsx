...
export default function CashBookPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Cash Book"
        description="Liquid cash flow — cash receipts and payments only"
      >
        <Button variant="outline" onClick={loadCashBook} disabled={isLoading}>
      ...
      <Card>
        <CardContent className="pt-4">
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <Button onClick={loadCashBook} disabled={isLoading || !startDate || !endDate}>
      ...
      {summary && (
        <div className="grid gap-4 sm:grid-cols-4">
          <StatCard
            ...
            icon={Banknote}
            description={`Cash before ${formatDate(startDate)}`}
          />
          <StatCard
            title="Cash In"
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              <p>No cash transactions for the selected period</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow className="bg-muted/30">
                    <TableCell colSpan={4} className="text-sm font-medium text-muted-foreground">
                      Cash Balance — {formatDate(endDate)}
                    </TableCell>
